...
Mit Hilfe der "Ubergangsfunktion wird dann der nächste Zustand,
...
\begin{definition}
\index{abzahlbar unendlich@abz\ählbar unendlich}
\index{uberabzahlbar unendlich@\überabz\ählbar unendlich}
