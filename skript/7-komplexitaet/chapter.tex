...
\input{7-komplexitaet/laufzeit.tex}
\input{7-komplexitaet/pnp.tex}
\input{7-komplexitaet/reduktion.tex}
\input{7-komplexitaet/npcomplete.tex}
\input{7-komplexitaet/sat.tex}
\input{7-komplexitaet/beispiele.tex}
\input{7-komplexitaet/katalog.tex}
\input{7-komplexitaet/karp.tex}
\input{7-komplexitaet/minesweeper.tex}
