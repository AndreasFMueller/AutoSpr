...
stellte er jedoch fest, dass jeder seiner W"ahler von irgendeiner
...
Wahlkampf sagen k"onnen: ``Vering hat mir alle Verg"unstigungen weggenommen!''
...
Das Ministerium beginnt also eine Liste von m"oglichen Zwangsfamilien
zu erstellen.
...
ausw"ahlen, dass genau das Restbudget verbraucht wird. Einige Tage sp"ater
wundert er sich, dass die Sekret"arin total "uberfordert ist. Ist er
am richtigen Ort?

\medskip

Nein, der Gruppenleiter h"atte erkennen m"ussen, dass er der Sekret"arin
...
\]
Dies ist das Problem {\it PARTITION}, es ist NP-vollst"andig.
...
aus Subventionen die Ziele $W$ des Managements "ubersteigen.
