...
\begin{beispiel}[\bf W"orter mit einer geraden Anzahl $0$]
Sei $\Sigma=\{{\tt a},{\tt b}\}$,
...
\subsection{Rekonstruktion des Automaten}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=0.9\hsize]{images/pl-2.pdf}\\
\includegraphics[width=0.9\hsize]{images/pl-1.pdf}\\
\includegraphics[width=0.9\hsize]{images/pl-3.pdf}\\
\includegraphics[width=0.9\hsize]{images/pl-4.pdf}
\end{tabular}
\end{center}
...
$\mathstrut^t$-Operation nicht "andern: $w^t=w$. Die Menge der Palindrom
ist nat"urlich eine Sprachen $L=\{w\in\Sigma^*\;|\;w^t=w\}$. 
...
\begin{tabular}{cccc}
&%
\includegraphics[width=0.35\hsize]{images/reg-2}&
\raisebox{60pt}{$\overset{\displaystyle\text{\tt b}}\longrightarrow$}&
\includegraphics[width=0.35\hsize]{images/reg-3}\\
\raisebox{60pt}{$\overset{\displaystyle\text{\tt a}}\longrightarrow$}&
\includegraphics[width=0.35\hsize]{images/reg-4}&
\raisebox{60pt}{$\overset{\displaystyle\text{\tt a}}\longrightarrow$}&
\includegraphics[width=0.35\hsize]{images/reg-5}
\end{tabular}
\end{center}
...
mit Backtr"acking. Da er sie in den public domain freigab, hat sie sich
...
\begin{center}
\includegraphics[width=0.6\hsize]{images/nea-1}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\hsize]{images/nea-2}
\end{center}
...
\section{Anhang: Regul"are Ausdr"ucke in der Praxis}
...
Ein DEA hat immer Laufzeit $O(n)$, d.~n.~ein Regex-Matcher auf der
...
\]
Und auch einen NEA findet manh aus der Konstruktion eines Automaten
