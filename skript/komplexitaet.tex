...
als $t(n)$. Zusammen mit den $t(n)$ durchläufen erhalten wir die Erkenntnis,
...
mit Hilfe der polynomiellen Verifizierer in ``leichte'' und ``schwierige'',
...
wir können dies durch den Ausdruck 
