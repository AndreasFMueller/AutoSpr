...
f"uhrenden Pfad in dem Graphen gibt. "Ubersetzt in ein Spracheproblem
...
Der Verifizierer verlangt als L"osungszertifikat $c$ eine
...
Zeit pr"ufen, ob die Bedingung verschiedener Farben an den Enden
...
Probleme gibt. Dies "anderte sich mit dem Satz von Cook und Levin,
...
vorkam, f"ugen wir zwischen den beiden der Klausel $c_j$
...
in einer Klausel wahr werden, die Summe der Spalte einer wahren Klausel kann
...
m"ussen alle in geeignete Zahlenmuster auf einem Minesweeper-Spielfeld
