...
Zur Abk"urzung erlauben wir, Regeln mit der gleichen Variable
...
auf er linken Seite des Pfeils $\rightarrow$ vorkommt. Regeln der
Form 
\[
{\tt a}A\to AA, \qquad {\tt bA}\to BB,
\]
sogenannte kontextsenstivie Regeln,
...
geschrieben $uAv\Rightarrow uwa$. Man sagt, $v$ l"asst sich aus
...
mit
\[
R_0=R\cup \{ S_0\to S_0S_0, S_0\to\varepsilon \}
\]
die Sprache $L^*$.
\end{proof}
