...
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm] (q2) -- (q4);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm] (q4) -- (q1);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm] (q1) -- (q3);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm] (q3) -- (q4);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm] (q1) -- (q5);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm]
	(q2) to[out=20,in=70,distance=1.4cm] (q2);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm]
	(q2) to[out=160,in=110,distance=1.4cm] (q2);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm]
	(q3) to[out=-20,in=-70,distance=1.4cm] (q3);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm]
	(q3) to[out=-160,in=-110,distance=1.4cm] (q3);
\node at ($0.5*(q0)+0.5*(q1)$) [below left]
	{$\varepsilon,\varepsilon\to\texttt{\$}$};
\node at ($0.5*(q5)+0.5*(q1)$) [above left]
	{$\varepsilon,\texttt{\$}\to\varepsilon$};
\node at ($0.5*(q2)+0.5*(q4)$) [above right]
	{$\varepsilon,\texttt{\$}\to\varepsilon$};
\node at ($0.5*(q3)+0.5*(q4)$) [below right]
	{$\varepsilon,\texttt{\$}\to\varepsilon$};
\node at ($0.5*(q1)+0.5*(q4)$) [above]
	{$\varepsilon,\varepsilon\to\texttt{\$}$};
\node at ($0.3*(q1)+0.7*(q2)$) [above left]
	{$\texttt{0},\varepsilon\to\texttt{0}$};
\node at ($0.3*(q1)+0.7*(q3)$) [below left]
	{$\texttt{1},\varepsilon\to\texttt{1}$};
\node at ($(q2)+(-0.2,1.1)$) [left] {$\texttt{0},\varepsilon\to\texttt{0}$};
\node at ($(q3)+(-0.2,-1.1)$) [left] {$\texttt{1},\varepsilon\to\texttt{1}$};
\node at ($(q2)+(0.2,1.1)$) [right] {$\texttt{1},\texttt{0}\to\varepsilon$};
\node at ($(q3)+(0.2,-1.1)$) [right] {$\texttt{0},\texttt{1}\to\varepsilon$};
\end{tikzpicture}
\end{center}
%\[
%\entrymodifiers={++[o][F]}
