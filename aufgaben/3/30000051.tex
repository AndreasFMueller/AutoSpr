...
\fill[color=darkgreen!20] (0,0) rectangle ++({4*\u},\u);
\draw (0,0) rectangle ({12*\u},\u);
\draw ({4*\u},0) -- ++(0,\u);
\node[color=darkgreen] at ({2*\u},{0.5*\u}) {$x\mathstrut$};
\node at ({12*\u},{0.5*\u}) [right] {$=d\mathstrut$};
\node at ({7*\u},{0.5*\u}) {\texttt{0}\strut};

\node at (0,{-\v+0.5*\u}) [left] {$\mathstrut+\mathstrut$};
\fill[color=darkred!20] ({4*\u},{-\v}) rectangle ++({3*\u},\u);
\draw ({4*\u},{-\v}) rectangle ++({8*\u},\u);
\draw ({7*\u},{-\v}) -- ++(0,\u);
\node[color=darkred] at ({5.5*\u},{-\v+0.5*\u}) {$y\mathstrut$};
\node at ({12*\u},{-\v+0.5*\u}) [right] {$=e\mathstrut$};
\node at ({9.5*\u},{-\v+0.5*\u}) {\texttt{0}\strut};

\node at (0,{-2*\v+0.5*\u}) [left] {$\mathstrut+\mathstrut$};
\fill[color=blue!20] ({7*\u},{-2*\v}) rectangle ++({5*\u},\u);
\draw ({7*\u},{-2*\v}) rectangle ++({5*\u},\u);
\node[color=blue] at ({9.5*\u},{-2*\v+0.5*\u}) {$z\mathstrut$};
\node at ({12*\u},{-2*\v+0.5*\u}) [right] {$=f\mathstrut$};

\draw[line width=1pt] ({-\u},{-2.400*\v}) -- ++({14.6*\u},0);

\node at (0,{-3.5*\v+0.5*\u}) [left] {$\mathstrut=\mathstrut$};
\fill[color=darkgreen!20] (0,{-3.5*\v}) rectangle ++({4*\u},\u);
\fill[color=darkred!20] ({4*\u},{-3.5*\v}) rectangle ++({3*\u},\u);
\fill[color=blue!20] ({7*\u},{-3.5*\v}) rectangle ++({5*\u},\u);
\node[color=darkgreen] at ({2*\u},{-3.5*\v+0.5*\u}) {$x\mathstrut$};
\node[color=darkred] at ({5.5*\u},{-3.5*\v+0.5*\u}) {$y\mathstrut$};
\node[color=blue] at ({9.5*\u},{-3.5*\v+0.5*\u}) {$z\mathstrut$};
\draw ({4*\u},{-3.5*\v}) -- ++(0,\u);
\draw ({7*\u},{-3.5*\v}) -- ++(0,\u);
\draw (0,{-3.5*\v}) rectangle ++({12*\u},\u);
\node at ({12*\u},{-3.5*\v+0.5*\u}) [right] {$=p\mathstrut$};
...
\fill[color=darkgreen!20] (0,0) rectangle ++({4*\u},\u);
\draw (0,0) rectangle ({20*\u},\u);
\draw ({4*\u},0) -- ++(0,\u);
\node[color=darkgreen] at ({2*\u},{0.5*\u}) {$x\mathstrut$};
\node at ({20*\u},{0.5*\u}) [right] {$=ds^{k-1}\mathstrut$};
\node at ({12*\u},{0.5*\u}) {\texttt{0}\strut};

\node at (0,{-\v+0.5*\u}) [left] {$\mathstrut+\mathstrut$};
\fill[color=darkred!20] ({4*\u},{-\v}) rectangle ++({11*\u},\u);
\draw ({4*\u},{-\v}) rectangle ++({16*\u},\u);
\draw ({7*\u},{-\v}) -- ++(0,\u);
\draw ({9*\u},{-\v}) -- ++(0,\u);
\draw ({12*\u},{-\v}) -- ++(0,\u);
\draw ({15*\u},{-\v}) -- ++(0,\u);
\node[color=darkred] at ({5.5*\u},{-\v+0.5*\u}) {$y\mathstrut$};
\node[color=darkred] at ({8*\u},{-\v+0.5*\u}) {$\dots\mathstrut$};
\node[color=darkred] at ({10.5*\u},{-\v+0.5*\u}) {$y\mathstrut$};
\node[color=darkred] at ({13.5*\u},{-\v+0.5*\u}) {$y\mathstrut$};
\node at ({20*\u},{-\v+0.5*\u}) [right] {$=es^{k-1}+\dots+es+e\mathstrut$};
\node at ({17.5*\u},{-\v+0.5*\u}) {\texttt{0}\strut};

\node at (0,{-2*\v+0.5*\u}) [left] {$\mathstrut+\mathstrut$};
\fill[color=blue!20] ({15*\u},{-2*\v}) rectangle ++({5*\u},\u);
\draw ({15*\u},{-2*\v}) rectangle ++({5*\u},\u);
\node[color=blue] at ({17.5*\u},{-2*\v+0.5*\u}) {$z\mathstrut$};
\node at ({20*\u},{-2*\v+0.5*\u}) [right] {$=f\mathstrut$};

\draw[line width=1pt] ({-\u},{-2.400*\v}) -- ++({22.6*\u},0);

\node at (0,{-3.5*\v+0.5*\u}) [left] {$\mathstrut=\mathstrut$};
\fill[color=darkgreen!20] (0,{-3.5*\v}) rectangle ++({4*\u},\u);
\fill[color=darkred!20] ({4*\u},{-3.5*\v}) rectangle ++({11*\u},\u);
\fill[color=blue!20] ({15*\u},{-3.5*\v}) rectangle ++({5*\u},\u);
\node[color=darkgreen] at ({2*\u},{-3.5*\v+0.5*\u}) {$x\mathstrut$};
\node[color=darkred] at ({5.5*\u},{-3.5*\v+0.5*\u}) {$y\mathstrut$};
\node[color=darkred] at ({8*\u},{-3.5*\v+0.5*\u}) {$\dots\mathstrut$};
\node[color=darkred] at ({10.5*\u},{-3.5*\v+0.5*\u}) {$y\mathstrut$};
\node[color=darkred] at ({13.5*\u},{-3.5*\v+0.5*\u}) {$y\mathstrut$};
\node[color=blue] at ({17.5*\u},{-3.5*\v+0.5*\u}) {$z\mathstrut$};
\draw ({4*\u},{-3.5*\v}) -- ++(0,\u);
\draw ({7*\u},{-3.5*\v}) -- ++(0,\u);
\draw ({9*\u},{-3.5*\v}) -- ++(0,\u);
\draw ({12*\u},{-3.5*\v}) -- ++(0,\u);
\draw ({15*\u},{-3.5*\v}) -- ++(0,\u);
\draw (0,{-3.5*\v}) rectangle ++({20*\u},\u);
\node at ({20*\u},{-3.5*\v+0.5*\u}) [right] {$=v_b(w_k)\mathstrut$};
