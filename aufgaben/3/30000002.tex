...
\hline
$\varepsilon$&$L$&$=L_0$&nein\\
  {\tt a}&$\{w\in\Sigma^*\;|\;\text{$|w|$ ungerade, $|w|_{\text{\tt b}}$   gerade}\}$&$=L_1$&nein\\
  {\tt b}&$\{w\in\Sigma^*\;|\;\text{$|w|$ ungerade, $|w|_{\text{\tt b}}$ ungerade}\}$&$=L_3$&nein\\
 {\tt aa}&$\{w\in\Sigma^*\;|\;\text{$|w|$ gerade,   $|w|_{\text{\tt b}}$   gerade}\}$&$=L_0$&nein\\
 {\tt ab}&$\{w\in\Sigma^*\;|\;\text{$|w|$ gerade,   $|w|_{\text{\tt b}}$ ungerade}\}$&$=L_2$&ja\\
 {\tt bb}&$\{w\in\Sigma^*\;|\;\text{$|w|$ gerade,   $|w|_{\text{\tt b}}$   gerade}\}$&$=L_0$&nein\\
{\tt aaa}&$\{w\in\Sigma^*\;|\;\text{$|w|$ ungerade, $|w|_{\text{\tt b}}$   gerade}\}$&$=L_1$&nein\\
{\tt aab}&$\{w\in\Sigma^*\;|\;\text{$|w|$ ungerade, $|w|_{\text{\tt b}}$ ungerade}\}$&$=L_3$&nein\\
{\tt abb}&$\{w\in\Sigma^*\;|\;\text{$|w|$ ungerade, $|w|_{\text{\tt b}}$   gerade}\}$&$=L_1$&nein\\
{\tt bbb}&$\{w\in\Sigma^*\;|\;\text{$|w|$ ungerade, $|w|_{\text{\tt b}}$ ungerade}\}$&$=L_3$&nein\\
\hline
\end{tabular}
\end{center}
