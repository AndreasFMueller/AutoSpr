...
$\varepsilon$&$L$&$=L_0$&nein\\
 ...
 {\tt bb}&$\{w\in\Sigma_1^*\;|\;\text{$|w|_{\text{\tt a}}$ gerade,   $|w|_{\text{\tt b}}\ge 0$}\}$&$=L_4$&nein\\
...
{\tt abb}&$\{w\in\Sigma_1^*\;|\;\text{$|w|_{\text{\tt a}}$ ungerade, $|w|_{\text{\tt b}}\ge 0$}\}$&$=L_5$&ja\\
{\tt bbb}&$\{w\in\Sigma_1^*\;|\;\text{$|w|_{\text{\tt a}}$ gerade,   $|w|_{\text{\tt b}}\ge 0$}\}$&$=L_4$&nein\\
\hline
\end{tabular}
\end{center}
...
$\varepsilon$&$L$&$=L_0$&ja\\
  {\tt 0}&$\emptyset$&$=L_0$&ja\\
  {\tt 1}&$\{ w\in\Sigma_2^*\;|\; \text{an jeder geraden Stelle eine {\tt 1}}\}$&$=L_1$&nein\\
...
{\tt 111}&$\{ w\in\Sigma_2^*\;|\; \text{an jeder geraden Stelle eine {\tt 1}}\}$&$=L_1$&nein\\
\hline
\end{tabular}
\end{center}
