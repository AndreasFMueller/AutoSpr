...
\draw (q7) circle[radius=0.4];
\draw (q7) circle[radius=0.35];
...
\draw (q3) circle[radius=0.4];
\draw (q7) circle[radius=0.4];
\draw (r0) circle[radius=0.4];
\draw (r0) circle[radius=0.35];
\draw (r1) circle[radius=0.4];
\draw (r2) circle[radius=0.4];
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm]
	(s) -- (q1);
\draw[->,shorten >= 0.4cm,shorten <= 0.4cm]
	(q3) -- (q7);
