...
\begin{scope}
\fill[color=white] ({-\h/2},{-\h/2}) rectangle ++({13*\h},\h);
\draw ({-\h/2},{-\h/2}) rectangle ++({13*\h},\h);
\draw ({\h/2},{-\h/2}) -- ++(0,\h);
\draw ({5.5*\h},{-\h/2}) -- ++(0,\h);
\draw ({6.5*\h},{-\h/2}) -- ++(0,\h);
\draw ({7.5*\h},{-\h/2}) -- ++(0,\h);
...
\fill[color=white] ({-\h/2},{-\h/2}) rectangle ++({13*\h},\h);
\fill[color=darkgreen!20] ({-0.5*\h},{-0.5*\h}) rectangle ({2.5*\h},{0.5*\h});
\fill[color=darkred!20] ({2.5*\h},{-0.5*\h}) rectangle ({4.5*\h},{0.5*\h});
\fill[color=blue!20] ({4.5*\h},{-0.5*\h}) rectangle ({12.5*\h},{0.5*\h});
\draw[color=gray!40] ({\h/2},{-\h/2}) -- ++(0,\h);
\draw[color=gray!20] ({5.5*\h},{-\h/2}) -- ++(0,\h);
\draw[color=gray!20] ({6.5*\h},{-\h/2}) -- ++(0,\h);
\draw[color=gray!20] ({7.5*\h},{-\h/2}) -- ++(0,\h);
\draw ({-\h/2},{-\h/2}) rectangle ++({13*\h},\h);
